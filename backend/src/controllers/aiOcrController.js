...
/**
 * Endpoint to extract document data using AI OCR
 * @param {import('express').Request} req 
 * @param {import('express').Response} res 
 */
exports.extractDocument = async (req, res) => {
  ...
  try {
    ...
    const imageParts = files.map((/** @type {{ mimetype: any; buffer: { toString: (arg0: string) => any; }; }} */ file) => ({
      inlineData: {
...
/**
 * Endpoint to get AI Usage Statistics & Recent Logs
 * @param {import('express').Request} req 
 * @param {import('express').Response} res 
 */
