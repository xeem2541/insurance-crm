...
const IssuePolicyMotorForm = () => {
  ...
  const handleAIExtract = async (e) => {
    ...
    try {
      ...
      // Handle the leaked Authorization header error gracefully just in case, or any other auth error
  ...
  const DRAFT_KEY = 'draft_IssuePolicyMotorForm';
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      ...
      if (customer.first_name || vehicle.plate_no || policy.policy_no) {
              ...
              <Row className="g-3 mb-4">
                ...
                <Col md={4}>
                  ...
                  <Select noOptionsMessage={() => "ไม่พบข้อมูล"} 
                    options={policyTypes} 
                    value={policyTypes.find(t => t.value === policy.type)} 
                    onChange={opt => {
...
export default IssuePolicyMotorForm;
