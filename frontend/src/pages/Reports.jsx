...
const Reports = () => {
  ...
  const [reportType, setReportType] = useState('motor_sales_monthly');
            ...
            <div className="col-md-3">
              ...
              <select className="form-select" value={reportType} onChange={e => setReportType(e.target.value)}>
                <optgroup label="Motor Insurance">
                  <option value="motor_sales_daily">ยอดขายรายวัน (Motor)</option>
                  <option value="motor_sales_monthly">ยอดขายรายเดือน (Motor)</option>
                  <option value="motor_renewal">ต่ออายุ (Motor)</option>
                  <option value="motor_arrears">ค้างชำระ (Motor)</option>
                </optgroup>
