...
('VehicleType', 'รถจักรยานยนต์'), ('VehicleType', 'รถยนต์บรรทุกส่วนบุคคล (กระบะตอนเดียว/แค็บ)'), ('VehicleType', 'รถยนต์นั่งส่วนบุคคลไม่เกิน 7 คน'), ('VehicleType', 'รถยนต์บรรทุกส่วนบุคคล (ดับเบิลแค็บ 4 ประตู)'), ('VehicleType', 'รถยนต์โดยสาร'), ('VehicleType', 'รถบรรทุก 6 ล้อ หรือ รถยนต์บรรทุก'), ('VehicleType', 'รถบรรทุก 10 ล้อ หรือ รถยนต์บรรทุก'), ('VehicleType', 'รถลากจูงและรถกึ่งพ่วง / รถพ่วง'), ('VehicleType', 'รถเพื่อการเกษตร (เช่น รถไถนา รถเกี่ยวข้าว รถตัดอ้อย)'),
