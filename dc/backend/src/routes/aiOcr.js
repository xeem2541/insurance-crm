  ...
  try {
    ...
    โครงสร้าง JSON ที่ต้องการส่งกลับ (ห้ามเปลี่ยนชื่อ Key เด็ดขาด):
    {
      ...
      "policy": {
        ...
        "start_date": "วันเริ่มต้นคุ้มครอง (YYYY-MM-DD) (ห้ามดึงข้อมูลวัน พ.ร.บ. เว้นแต่เป็นกรมธรรม์ พ.ร.บ.)",
        "expiry_date": "วันสิ้นสุดคุ้มครอง (YYYY-MM-DD) (ห้ามดึงข้อมูลวัน พ.ร.บ. เว้นแต่เป็นกรมธรรม์ พ.ร.บ.)"
      }
    }`;
