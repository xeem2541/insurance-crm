...
router.post('/extract', authenticateToken, upload.array('images', 10), async (req, res) => {
  ...
  try {
    ...
    8. การคัดแยกประเภทการรับประกันภัยและการแปลงค่ามาตรฐาน (Policy Type & Category Mapping Checklist):
       ...
       - หากเอกสารเป็นประกันภัยประเภทอื่นที่ไม่ใช่เกี่ยวกับรถยนต์ เช่น ประกันสุขภาพ, ประกันอุบัติเหตุส่วนบุคคล, ประกันอัคคีภัย, ประกันขนส่ง, ประกันชีวิต ให้ระบุ policy.category = "non-motor" และปล่อยฟิลด์ข้อมูลตัวรถ (vehicle) เป็นสตริงว่างทั้งหมด ""
       - แปลงค่าประเภทประกันภัยในฟิลด์ policy.type เป็นภาษาไทยให้ตรงกับมาตรฐานประเภทกรมธรรม์ของระบบ 100% เสมอตามเกณฑ์นี้:
         ...
         * ประกันภัยรถยนต์สมัครใจชั้น 3+ ➡️ "ประกันภัยชั้น 3+"
         * ประกันภัยรถยนต์สมัครใจชั้น 3 ➡️ "ประกันภัยชั้น 3"
         * พ.ร.บ. / ประกันภัยภาคบังคับ ➡️ "พ.ร.บ." (ให้ใช้เฉพาะคำว่า "พ.ร.บ." ห้ามมีคำนำหน้าอื่น)
         * ประกันอุบัติเหตุส่วนบุคคล / PA ➡️ "ประกันภัยอุบัติเหตุ PA"
         * ประกันภัยขนส่งสินค้า / ขนส่งทางบก/ทะเล ➡️ "ประกันภัยขนส่งสินค้า"
         * ประกันอัคคีภัย / ไฟไหม้ / อัคคีภัยที่อยู่อาศัย ➡️ "ประกันภัยอัคคีภัย/ไฟไหม้"
         * ประกันภัยความรับผิดต่อบุคคลภายนอก ➡️ "ประกันภัยรับผิดบุคคลภายนอก"
         * ประกันภัยรับเหมาก่อสร้าง / CAR ➡️ "ประกันภัยรับเหมา"
         * ประกันภัยความรับผิดวิชาชีพ ➡️ "ประกันภัยวิชาชีพ"
         * ประกันภัยสุขภาพ / ค่ารักษาพยาบาล ➡️ "ประกันภัยสุขภาพ"
         * ประกันภัยเงินออม / สะสมทรัพย์ ➡️ "ประกันภัยเงินออม"
         * ประกันชีวิต T Life / ทิพยไลฟ์ / ทีไลฟ์ ➡️ "ประกันภัย T Life"
    ...
    if (modelsToTry.length === 0) {
      modelsToTry = [
        ...
        { name: 'gemini-2.0-flash', timeout: 35000 },
