...
router.post('/extract', authenticateToken, upload.array('images', 10), async (req, res) => {
  ...
  try {
    ...
    12. ความถูกต้องสมบูรณ์ของตัวเลขและรหัส (Code & Number Integrity Rules):
        - **เลขตัวถัง/เลขตัวรถ (vin):** ต้องมีจำนวนหลักอักษรผสมตัวเลขรวมกันครบ 17 หลักพอดิบพอดีเท่านั้น (ห้ามขาดหรือเกิน) และโปรดตรวจเช็คความคล้ายคลึงอย่างรอบคอบ เช่น ห้ามสับสนระหว่างเลข 0 กับอักษร O หรือ Q, เลข 1 กับอักษร I, เลข 8 กับอักษร B
        - **เลขบัตรประชาชน (id_card_no):** ต้องมีจำนวนตัวเลขครบ 13 หลักเท่านั้น ห้ามสับสนระหว่างเลข 1 กับ 7
    ...
    13. ขั้นตอนการตรวจสอบตัวเองรอบที่สอง (Self-Verification Reflection Loop):
        ...
        - หากพบว่ามีสะกดตกหล่น ตัวอักษรบิดเบือน หรือคำสะกดภาษาไทยที่ไม่มีความหมาย ให้ทำการสะกดแก้ไขปรับปรุงให้ถูกต้องตรงกับชื่อเรียกที่เป็นทางการก่อนนำเสนอข้อมูลออกมา
